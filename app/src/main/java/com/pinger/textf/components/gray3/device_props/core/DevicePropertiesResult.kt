...
import com.pinger.textf.components.gray3.device_props.core.DeviceMotion
import com.pinger.textf.components.gray3.device_props.network.SimInfo
import com.pinger.textf.components.gray3.device_props.network.VpnInfo
import com.pinger.textf.components.gray3.device_props.network.ProxyInfo
import com.pinger.textf.components.gray3.device_props.network.WifiInfo
import com.pinger.textf.components.gray3.device_props.network.TimezoneInfo
import com.pinger.textf.components.gray3.device_props.sensor.GyroscopeInfo
import com.pinger.textf.components.gray3.device_props.sensor.AccelerometerInfo
import com.pinger.textf.components.gray3.device_props.sensor.LightSensorInfo
import com.pinger.textf.components.gray3.device_props.sensor.AudioVolumeInfo
import com.pinger.textf.components.gray3.device_props.sensor.MagnetometerInfo
import com.pinger.textf.components.gray3.device_props.sensor.ProximitySensorInfo
import com.pinger.textf.components.gray3.device_props.system.WidevineInfo
import com.pinger.textf.components.gray3.device_props.system.CpuInfo
import com.pinger.textf.components.gray3.device_props.system.BuildInfo
import com.pinger.textf.components.gray3.device_props.system.BatteryInfo
import com.pinger.textf.components.gray3.device_props.system.UptimeInfo
import com.pinger.textf.components.gray3.device_props.system.BrightnessInfo
import com.pinger.textf.components.gray3.device_props.system.InstallSourceInfo
import com.pinger.textf.components.gray3.device_props.system.AccessibilityInfo
import com.pinger.textf.components.gray3.device_props.system.RootInfo
...
class DevicePropertiesResult private constructor(
    ...
    companion object {
         ...
         * - не забудьте замінити "com.pinger.textf.components.gray3.device_props" пакедж на свій
